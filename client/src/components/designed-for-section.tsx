          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-text-primary text-sm sm:text-base leading-relaxed">
                Como cristão, você sabe a importância de ensinar os seus filhos a{' '}
                <span className="font-bold text-accent-blue">amar a palavra de Deus</span> e a{' '}
                <span className="font-bold text-accent-blue">SEGUIR os valores cristãos</span>.
                Esse material é uma ferramenta incrível para te ajudar nesse desafio.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-text-primary text-sm sm:text-base leading-relaxed">
                ...
                <span className="font-bold text-accent-green">grande aliado na rotina do ministério infantil</span>.
                Ele é ideal para escola bíblica, culto kids, culto doméstico e na 
                doutrinação infantil no geral.
              </p>
            </div>
          </motion.div>
        </div>
