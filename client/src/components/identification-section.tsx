...
export function IdentificationSection() {
  ...
  return (
    <section className="py-12 sm:py-16 px-4 bg-gradient-to-br from-secondary/30 to-background w-full overflow-hidden">
      <div className="max-w-6xl mx-auto mobile-padding">
          ...
          {situations.map((situation, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-background/90 backdrop-blur-sm rounded-2xl p-6 border border-border/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
                data-testid={`situation-card-${index}`}
              >
                <div className="flex items-start space-x-4">
                  <div className={`flex-shrink-0 p-3 rounded-full ${situation.bgColor} ${situation.borderColor} border-2`}>
        ...
        >
          <div className="bg-gradient-to-r from-accent to-accent/80 rounded-2xl p-6 border-2 border-accent/30 shadow-lg max-w-3xl mx-auto">
