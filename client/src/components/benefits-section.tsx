    ...
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-dark-secondary/80 backdrop-blur-sm rounded-2xl p-8 mb-8 border border-dark-tertiary"
        >
          <div className="space-y-6">
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <div>
                  <p className="text-lg text-text-primary group-hover:text-accent-green transition-colors duration-300">
            ...
            >
              ...
              >
                <div className="flex items-center space-x-3">
                  <Star className="text-2xl text-accent-green h-6 w-6" />
                  <span className="text-lg font-semibold text-accent-green">{section.title}</span>
                </div>
                <motion.div
