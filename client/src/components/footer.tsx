  ...
  return (
    <footer className="py-8 sm:py-12 px-4 bg-secondary/30 border-t border-border">
      <div className="max-w-4xl mx-auto text-center mobile-padding">
        ...
        >
          <h4 className="text-base sm:text-lg font-semibold text-accent-green mb-2">
            {brandName}
          </h4>
        ...
        >
          <p>RY Digital</p>
          <p>Email: suporte@rydigital.com.br</p>
          <p>
            {brandName} - Copyright © 2020-2025. Todos os direitos reservados
          </p>
        </motion.div>
        ...
        >
          <p className="mb-2">
            Atividades bíblicas para crianças de 2 a 12 anos. Material educativo
            cristão
          </p>
          <p>
            ✝️{" "}
            <span className="text-accent-green">
              Para aproximar as crianças da palavra de Deus.
            </span>
          </p>
        </motion.div>
      </div>
